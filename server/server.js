...
{/*
  ...
  weekly motivational emails - 6,12 months both are same

  UserDashboard :

    Email 
   - User purchase membership on x date, then he should only get the emails from that x date to x+n date ( till the date going)
   - User can able to see the email from the dashboard or from his Email. 
   Recepies
   - User purchase membership on x date, then he should only get the Recepies from that x date to x+n date. And this depends on the month that admin will add that recepie from the admin panel
